...
```
    ...
    if (route) {
        detailsDiv.innerHTML = "<p><strong>Route:</strong> " + route.route + "</p><p><strong>Estimated Time:</strong> " + route.time + "</p><p><strong>Distance:</strong> " + route.distance + "</p>";
        resultsDiv.classList.remove('hidden');
    } else {
        detailsDiv.innerHTML = "<p>No specific alternate route found. Try avoiding 294-355 by using:</p><p>• Surface streets like Roosevelt, Ogden, or North Ave</p><p>• Route 53 or Route 83 as north-south alternatives</p>";
        resultsDiv.classList.remove('hidden');
    }
});
```
